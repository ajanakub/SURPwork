## Bukola Ajanaku
## July 24, 2021
## forATAC.R: made after running CTCF enrichments on DNA methylation and seeing a
##            bunch of background noise
## on screen 3 as forATAC
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACCRDDensity.pdf", width = 20,
  height = 5)
  ggplot(CRD_CTCF_density_df, aes(Distance, Density_CRD, color = L1)) + geom_point() + geom_line() + xlim(-2e5, 2e5)
dev.off()

# another plot of the CTCF density using ATAC sequence:

pdf("/sc/arion/projects/epigenAD/Bukola/ATACCRDDensity2.pdf", width = 20,
  height = 5)
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACviewScatterPlots.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACbyNviewScatterPlots.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10highMAClowLEF.pdf")
...
tenlowmachighleffirst5 <- gatherData("10", "chr1", as.numeric(summary(clstScore[["10"]][clstScore[["10"]]$chrom == "chr1", "mean_abs_corr"])[1]),
  as.numeric(summary(clstScore[["10"]][clstScore[["10"]]$chrom == "chr1", "LEF"])[4]), 1, 3)
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10lowMAChighLEFonly3.pdf")
...
tenlowmaclowleffirst5 <- gatherData("10", "chr1", as.numeric(summary(clstScore[["10"]][clstScore[["10"]]$chrom == "chr1", "mean_abs_corr"])[2]),
  as.numeric(summary(clstScore[["10"]][clstScore[["10"]]$chrom == "chr1", "LEF"])[2]), 1, 5)
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10lowMAClowLEF.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10highMAChighLEF.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10highMAClowLEFFIRST2.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10lowMAChighLEFFIRST2.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10lowMAClowLEFFIRST2.pdf")
...
pdf("/sc/arion/projects/epigenAD/Bukola/ATACclst10highMAChighLEFFIRST2.pdf")
